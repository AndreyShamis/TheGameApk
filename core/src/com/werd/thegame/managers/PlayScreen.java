...
public class PlayScreen implements Screen {
    ...
    final TheGame game;
    private static final String TAG = "TheGame-PlayScreen";
    ...
    public PlayScreen(final TheGame gam, String strLevel, String strNextLevel) {
        game = gam;
        this.sL = strLevel;
